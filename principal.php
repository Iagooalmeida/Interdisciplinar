...
<body>
    ...
    <header id="cabecalho">
        <div class="contato">
            <div class="head_contact">
                <a href="#"><h3>Tel: (19) 3843-1996</h3></a> 
                <a href="mailto:"><h3>E-mail: email@email.com.br</h3></a> 
            </div>
            ...
            <div class="page">
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            De acordo com o artigo 35 do Regulamento Geral dos Cursos das Fatecs, o aluno veterano tem a opção de fazer até dois trancamentos
                             de matrícula, seja de forma consecutiva ou não. Para solicitar o trancamento, o aluno deve comparecer à Secretaria Acadêmica da 
                             Unidade com a sua carteirinha e preencher um requerimento de solicitação de trancamento. É importante observar que o pedido de 
                             trancamento de matrícula só pode ser realizado dentro do prazo final estipulado no Calendário Acadêmico, 
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            Os atestados devem ser solicitados no sistema SIGA (Sistema Integrado de Gestão Acadêmica), na opção Solicitação de Documentos. <br>
                        </p>
                        <p>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            Para obter o horário de aula atualizado da Fatec de Itapira, aconselho acessar o site oficial da instituição. Lá, você encontrará 
                            informações detalhadas sobre os horários de aula de cada curso oferecido, bem como outras informações relevantes sobre a instituição.
                            É sempre recomendável verificar o site da Fatec de Itapira regularmente, pois o horário de aula pode ser atualizado a cada semestre 
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            Para fazer a rematrícula o aluno deve acessar o sistema SIGA (Sistema Integrado de Gestão Acadêmica) dentro do prazo de rematrícula, 
                            conforme previsão do Calendário de Escolar e clicar em Rematrícula. Cabe lembrar que a rematrícula só estará liberada após a entrega
                            de todos os documentos originais solicitados pela secretaria, e após a confirmação de recebimento do e-mail com as instruções para a rematrícula.
                        </p>
                        <p>
                            O acesso ao SIGA e o Calendário Escolar poderá ser consultados nos <strong>links abaixo:</strong>
                        </p>
                        <hr>
                        <div class="pag_links">
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            O aluno que não conseguir acessar o sistema SIGA (Sistema Integrado de Gestão Acadêmica) deverá enviar uma mensagem eletrônica, DO SEU E-MAIL INSTITUCIONAL,
                             para o endereço <i>f278acad@cps.sp.gov.br</i> solicitando uma nova senha ou o desbloqueio do seu acesso. Caso o problema de acesso seja o esquecimento da senha,
                              a Secretaria Acadêmica irá responder este e-mail com a nova senha temporária.  <br><br> <strong>Link abaixo:</strong> 
                        </p>
                        <hr>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            Cada curso na Fatec de Itapira possui um coordenador responsável por auxiliar os alunos. O Coordenador é um docente eleito
                            pelos docentes e designado pela Direção para desempenhar um papel importante na orientação dos estudantes, no acompanhamento
                            do currículo do curso e na resolução de questões acadêmicas relacionadas ao programa de estudos. O Coordenador do curso está
                            disponível para esclarecer dúvidas, fornece orientações sobre disciplinas, carga horária, estágios, projetos, entre outros 
                            assuntos relacionados ao curso. Além disso, o Coordenador pode ajudar a resolver questões administrativas e fornecer informações
                            relevantes sobre a área de estudo do curso.
                        </p>
                        <p>
                            - <strong>CST em Gestão da Produção Industrial</strong> – Prof. José Marcos Romão Júnior <br>
                        ...
                        <p>
                            - <strong>CST em Desenvolvimento de Software Multiplataforma</strong> – Profa. Márcia Regina Reggiolli <br>
                            (marcia.reggiolli@fatec.sp.gov.br)
                        </p>
                        <p>
                            - <strong>CST em Gestão da Tecnologia da Informação</strong> – Prof. Mateus Guilherme Fuini <br>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            Sim, os alunos da Fatec de Itapira têm permissão para utilizar a biblioteca e as salas de estudos fora do horário de aula,
                            desde que esses espaços estejam abertos e haja funcionários presentes. A Fatec de Itapira reconhece a importância do acesso
                            a recursos educacionais e espaços adequados para estudo, e, portanto, permite que os alunos façam uso dessas instalações quando disponíveis. <br> 
                            É importante ressaltar que o acesso à biblioteca e às salas de estudos fora do horário de aula pode variar de acordo com as políticas internas
                            da instituição e as restrições aplicáveis em determinados períodos. Por isso, é recomendável verificar os horários de funcionamento e as regras
                            específicas junto à administração da Fatec de Itapira ou com os responsáveis pela biblioteca e pelas salas de estudos.
                        </p>
                    </div>
                </details>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            O horário de funcionamento da biblioteca e da sala de estudos neste 1º semestre de 2023 ocorre: <br><br>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            O Processo Seletivo Vestibular da Fatec de Itapira para ingresso de novos alunos acontece duas vezes por ano. 
                            Essas datas costumam ser nos últimos meses de cada semestre. <br>
                            As aulas para o 1º semestre geralmente começam na primeira quinzena do mês de fevereiro. Esse é o período em 
                            que os alunos aprovados no vestibular iniciam suas atividades acadêmicas na instituição. <br>
                            Já as aulas para o 2º semestre normalmente têm início na primeira quinzena do mês de agosto. Nesse momento, novos alunos aprovados
                            no processo seletivo têm a oportunidade de começar sua trajetória na Fatec de Itapira.
                        </p>
                        <p>
                            É importante lembrar que essas informações são baseadas em padrões gerais e podem estar sujeitas a alterações. Recomenda-se que os
                            interessados em ingressar na Fatec de Itapira consultem o site oficial da instituição ou entrem em contato com a Fatec de Itapira
                            para obter informações atualizadas sobre o calendário do processo seletivo e o início das aulas em cada semestre.
                        </p>
                    </div>
                </details>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            Atualmente a Fatec de Itapira oferece um total de 120 vagas, distribuídas entre os seguintes Cursos Superiores Tecnológicos:
                        </p>
                        <p>
                ...
                <details class="card">
                    ...
                    <div class="card__body">
                        <p>
                            De acordo com o Regulamento dos Cursos de Graduação das Fatecs existe a opção de transferência intercursos dentro das Fatecs,
                            porém como pré-requisito o aluno deve possuir pelo menos metade das disciplinas do 1º semestre do curso desejado eliminadas
                            com aproveitamento de estudos. Em seguida o candidato deverá acessar o site da Fatec de Itapira <a href="https://fatecitapira.edu.br" target="_blank">https://fatecitapira.edu.br </a> 
                            e fazer o download do Edital de Transferência Interna. A divulgação do edital ocorre um pouco antes período das inscrições 
                            para transferência cujas datas estão especificadas no Calendário Escolar também disponível no site https://fatecitapira.edu.br.  
                        </p>
                        <p>
    ...
    <footer class="rodape">
        ...
        <div class="Copyright">
            <h3>Copyright © 2023 Fatec Itapira - Todos os Direitos Reservados - Desenvolvido por alunos T.I. da Fatec</h3>
        </div>
    </footer>
